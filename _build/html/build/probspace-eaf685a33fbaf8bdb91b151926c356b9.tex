...
\begin{itemize}
\item \textbf{Finite} \(\Omega\): (i) , (ii), (iii)
\item \textbf{Countably infinite} \(\Omega\): (iv)
\item \textbf{Discrete} \(\Omega\):  (i)--(iv)
\item \textbf{Continuous (uncountably infinite)} \(\Omega\):  (v)
\end{itemize}
