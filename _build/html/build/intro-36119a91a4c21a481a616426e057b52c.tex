...
\begin{description}
\item[Theologian:]  We can't know God's mind! 
\item[Copenhagen quantum physicist:] The laws of quantum physics are fundamentally random.
\end{description}
  
 \subsection{What use of random?}
Atthough cannot perfectly determine a behavior, we still want to be
...
\subsection{How should we study probability?}
\begin{enumerate}
  \item Intuition\\
