...
\item Tossing a coin twice:  \(\mathcal{F} =\{\emptyset,\{H H\},\{T T\},\{H T\},\{T H\},
 \{H H, T T\},\{H H, H T\}, \ldots, 
\{H H, T T, H T\}, \cdots,\{H H, T T, H T, T T\}\)

\item Generally if \(\Omega=\left\{a_{1}, a_{2}, \ldots
a_{N}\right\}\), then \(\mathcal{F}=\left\{\phi,\left\{a_{1}\right\},
\ldots,\left\{a_{N}\right\},\left\{a_{1}, a_{2}\right\},
\ldots\left\{a_{1}, a_{2}, a_{3}\right\}, \ldots, \ldots\right.\)
\[
\left\{a_{1}, a_{2}, \ldots, a_{n}\right\}
\]
Altogether \(2^{N}\) event (why.) If which is usually deverted a \(2^{\Omega}\), the power set of \(\Omega\).
\end{enumerate}
