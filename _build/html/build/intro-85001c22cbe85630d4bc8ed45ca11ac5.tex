...
Venn diagram:\\
\includegraphics[max width=\textwidth, alt={}, center]{images/d9bd1b15-0be6-4153-b5f5-a3e74296fb76-05_566_775_2025_996}
...
\includegraphics[max width=\textwidth, alt={}, center]{images/d9bd1b15-0be6-4153-b5f5-a3e74296fb76-09_201_315_1664_1737}
...
\begin{itemize}
  ...
  \item[-] Now cansider a game tast includes two rounds of tossin the
    coin. In the first round, the cain is tossed in times! as
    above. In the second round, the coin is tossed \(k\) times where \(k\) is the \(\#\) of \(H\) sotained in the first round Want to find prob. if hourng \(l\). Its in the 2nd row
\end{itemize}
