...
there are 
uncountably infinite number of outcomes and hence the method of
enumeration used in the finite case can't be used to construct the
event space anymore.
\item Luckily mathematicians have solved the problem for us. To
discuss the solution, we need to study a bit about set calculus.
\end{itemize}

\subsection{Set Calculus}
