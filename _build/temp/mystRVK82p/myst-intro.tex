...
\subsubsection{What is \textit{random}?}

\begin{itemize}
\item Some behavior that we cannot perfectly predict, as oppose to being \textit{deterministic}.
\end{itemize}
...
\subsubsection{What to do with random?}
...
\item We will go through an engineering (more operational, less about math vigor) treatment of Probability Theory in this course.
\end{itemize}

\subsubsection{How to study probability?}
...
\begin{itemize}
\item \textit{\textbf{Example:}} Dr. Wong taught EEE 5544 three times in the past. There were altogether 200 students who took Dr. Wong's classes. Out of these 200 students, 50 of them got the $A$ grade. Thus the chance of getting an $A$ in Dr. Wong's class is $\frac{50}{200}=\frac{1}{4}$.
